                ...
                <div class="container">
                    <ul class="list-group list-group-flush">
                        ...
                        <c:forEach var="commentlist" items="${commentlist}"> 
                            <li class="list-group-item">От : ${commentlist.username} <small><i>дата ${commentlist.date}</i></small><br> Коментарий : ${commentlist.comment}</li>
                            </c:forEach>
                    ...
                    <section class="jumbotron">
                        <div class="container">
                            <h2>Обсудите ваш вопрос..</h2><br>
                            <form action="savecomment" method="POST">
                                <input type="hidden" name="username" value="${username}" >
                                <input type="hidden" name="videoid" value="${videoid}">
                                <textarea class="input-group form-control" type="text" name="comment" placeholder="Введите ваш вопрос.."></textarea>
                                <br>
