                ...
                <nav class="navbar navbar-expand-md font justify-content-center">
                    ...
                    <div class="" id="collapsibleNavbar">
                        <ul class="navbar-nav ml-auto justify-content-center text-white">
                            <li class="nav-item">
                                <a class="nav-link" href="student_home">Главная</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="student_subjects">Предметы</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Задания</a>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item font" href="upload_assign">Загрузить задание</a>
                                    <a class="dropdown-item font" href="uploaded_assignment">Подтвердить задания</a>
                                </div>
                            </li>
                            <li class="nav-item">
