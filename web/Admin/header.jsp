                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Запросы</a>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item font" href="view_request">Новые запросы</a>
                                    <a class="dropdown-item font" href="view_rejected_request">Отклонённые</a>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="list_school">Список организаций</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="mailinfo">Отправленные письма</a>
                            </li>
                            <li class="nav-item">
